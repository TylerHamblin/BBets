...
```
### Mr. Brownlow would be making the average of profit$mean. The 95% confidence level test we ran has an ever changing range that typically spans about $100. The average earnings Browlow makes are ran by the second code chunk with the upper and lower possibilities.  
